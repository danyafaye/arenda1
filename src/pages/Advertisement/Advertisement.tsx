      ...
      <div className={b('block')}>
        ...
        <div className={b('block-text')}>
          ...
          <div className={b('block-description')}>
            Для инвестиций или жизни! Студия с ремонтом и мебелью Кафель в санузле, душевая кабина. Хорошая сантехника.
            Спальное место выделено на второй этаж. Во дворе есть парковка.
          </div>
          <div className={b('block-buttons')}>
            <button className={b('button')}>Аренда</button>
          </div>
        </div>
      </div>
      <div className={b('block')}>
        ...
        <div className={b('block-text')}>
          ...
          <div className={b('block-description')}>
            Арт. 13516614 Просторная! 3-ех комнатная квартира в Сталинском доме!!! Это отличный дом для семьи или для
            сдачи в аренду ценителям комфортного жилья.
          </div>
          <div className={b('block-buttons')}>
            <button className={b('button')}>Аренда</button>
          </div>
